...
- [Server Security Guide](../guides/SERVER_SECURITY.md) — auth, TLS, shutdown, health endpoints
- [Configuration Reference](../guides/CONFIGURATION.md) — all options with env vars, CLI flags, TOML keys
