...
```bash
# Download
wget https://github.com/cyberlife-coder/VelesDB/releases/download/v5.2.0/velesdb-5.2.0-amd64.deb

# Install
sudo dpkg -i velesdb-5.2.0-amd64.deb
...
docker pull ghcr.io/cyberlife-coder/velesdb:5.2.0
...
docker run -d --name velesdb -p 8080:8080 -v velesdb_data:/data \
  ghcr.io/cyberlife-coder/velesdb:5.2.0
```
