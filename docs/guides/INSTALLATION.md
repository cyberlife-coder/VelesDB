...
```bash
# Download
wget https://github.com/cyberlife-coder/VelesDB/releases/download/v3.5.0/velesdb-3.5.0-amd64.deb

# Install
sudo dpkg -i velesdb-3.5.0-amd64.deb
...
docker pull ghcr.io/cyberlife-coder/velesdb:3.5.0
...
docker run -d --name velesdb -p 8080:8080 -v velesdb_data:/data \
  ghcr.io/cyberlife-coder/velesdb:3.5.0
```
