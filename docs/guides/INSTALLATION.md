...
msiexec /i velesdb-1.11.1-x86_64.msi /quiet ADDTOPATH=1

# Install without PATH modification
msiexec /i velesdb-1.11.1-x86_64.msi /quiet ADDTOPATH=0

# Install to custom directory
msiexec /i velesdb-1.11.1-x86_64.msi /quiet APPLICATIONFOLDER="D:\VelesDB"
```
...
```powershell
msiexec /x velesdb-1.11.1-x86_64.msi /quiet
```
...
Invoke-WebRequest -Uri "https://github.com/cyberlife-coder/VelesDB/releases/download/v1.11.1/velesdb-windows-x86_64.zip" -OutFile velesdb.zip
...
```bash
# Download
wget https://github.com/cyberlife-coder/VelesDB/releases/download/v1.11.1/velesdb-1.11.1-amd64.deb

# Install
sudo dpkg -i velesdb-1.11.1-amd64.deb
...
```bash
# Download and extract
wget https://github.com/cyberlife-coder/VelesDB/releases/download/v1.11.1/velesdb-linux-x86_64.tar.gz
