...
| `-h, --help` / `-V, --version` | Help / version (`velesdb-migrate 5.2.0`) |
...
`velesdb-migrate v5.2.0` · Last updated: 2026-08-22 · Applies to: velesdb-core 5.2.0 · [Report a docs error](https://github.com/cyberlife-coder/VelesDB/issues)
