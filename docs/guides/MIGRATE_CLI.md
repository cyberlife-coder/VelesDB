...
| `-h, --help` / `-V, --version` | Help / version (`velesdb-migrate 6.0.0`) |
...
`velesdb-migrate v6.0.0` · Last updated: 2026-09-02 · Applies to: velesdb-core 6.0.0 · [Report a docs error](https://github.com/cyberlife-coder/VelesDB/issues)
