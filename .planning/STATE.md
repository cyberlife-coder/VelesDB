...
| 3 - SDK Fixes | ✅ Complete (01-06 all done) | T-01→03, BEG-07 + full parity | 🐛 Contracts |
...
*Status: v3 Phase 3 COMPLETE (Plans 01-06 all done). 223 tests, 7 files. Next: Phase 4 (Python) or v2. v2 deferred.*
