...
| 3 - SDK Fixes | 🟡 In Progress (01-04 ✅, 05-06 next) | T-01→03, BEG-07 + full parity | 🐛 Contracts |
...
*Status: v3 Phase 3 in progress (Plans 01-04 ✅, Plan 05 next — SELECT builder). 165 tests. v2 deferred.*
