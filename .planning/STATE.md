...
| 3 - SDK Fixes | 🟡 In Progress (01 ✅ 02 ✅ 03 ✅, 04-06 next) | T-01→03, BEG-07 + full parity | 🐛 Contracts |
...
*Status: v3 Phase 3 in progress (Plans 01-03 ✅, Plan 04 next — rest.ts extraction). 165 tests. v2 deferred.*
