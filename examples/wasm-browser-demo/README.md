...
# Change: import init from 'https://unpkg.com/@wiscale/velesdb-wasm@2.0.0/velesdb_wasm.js'
...
<script type="module">
  // If published on npm:
  // import init, { VectorStore } from 'https://unpkg.com/@wiscale/velesdb-wasm@2.0.0/velesdb_wasm.js';
