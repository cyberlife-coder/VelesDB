...
def example_add_edges():
    ...
    print("Python SDK:")
    print("  # Create database and collection")
    print("  db = Database('./data')")
    print("  collection = db.create_collection('knowledge', dimension=384)")
    print()
    print("  # Add edges (relationships)")
    print("  collection.add_edge(")
    print("      id=1,")
    print("      source=100,      # Node: 'Python'")
    print("      target=200,      # Node: 'Programming Language'")
    print("      label='is_a',")
    print("      metadata={'confidence': 0.99}")
    print("  )")
    print()
    print("  collection.add_edge(")
    print("      id=2,")
    ...
    print("      metadata={'popularity': 'high'}")
    print("  )")
    print()
    print("CLI:")
...
def example_dfs_traversal():
    ...
    print("      strategy='dfs',       # Depth-first")
    print("      limit=100             # All relationship types")
    print("  )")
    print()
    print("  for node in results:")
...
def example_graph_rag():
    ...
    print("      neighbors = collection.traverse(")
...
def example_node_degree():
    ...
    print("Python SDK:")
    print("  degree = collection.get_node_degree(100)")
