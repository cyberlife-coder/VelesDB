...
<p align="center">
  ...
  <a href="https://github.com/cyberlife-coder/VelesDB/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-VelesDB_Core_1.0-blue?style=flat-square" alt="License"></a>
...
```bash
cargo install velesdb-cli velesdb-server
```
...
## 🧭 New to VelesDB? Quick Diagnosis
