...
#[openapi(
    ...
    paths(
        ...
        handlers::graph::handlers::remove_edge,
        handlers::graph::handlers::get_edge_count,
        handlers::graph::handlers::list_nodes,
        handlers::graph::handlers::get_node_edges,
        handlers::graph::handlers::get_node_payload,
        handlers::graph::handlers::upsert_node_payload,
        handlers::graph::handlers::traverse_graph,
        handlers::graph::handlers::traverse_parallel,
        handlers::graph::handlers::get_node_degree,
        handlers::graph::handlers::graph_search,
