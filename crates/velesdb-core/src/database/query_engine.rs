...
impl Database {
    ...
    fn is_lookup_join_eligible(join: &crate::velesql::JoinClause) -> bool {
    ...
    fn merge_payloads(left: &crate::Point, right: &crate::Point) -> crate::Point {
