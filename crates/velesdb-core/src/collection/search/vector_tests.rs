...
// FIXME: Tests disabled — `estimate_real_selectivity` was renamed to
// `estimate_filter_selectivity` and `SELECTIVITY_THRESHOLD` was removed.
// Re-enable once the test module is updated to match the current API.
// #[cfg(test)]
