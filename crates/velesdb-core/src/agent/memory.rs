...
impl<'a> AgentMemory<'a> {
    ...
    /// # Errors
    ///
    /// Returns an error when one of the backing collections cannot be created/opened.
    ...
    /// # Errors
    ///
    /// Returns an error when episodic consolidation fails due to collection access/write errors.
    ...
    /// # Errors
    ///
    /// Returns an error when snapshot management is not configured or snapshot creation fails.
    ...
    /// # Errors
    ///
    /// Returns an error when snapshot management is not configured or loading/restoring fails.
    ...
    /// # Errors
    ///
    /// Returns an error when snapshot management is not configured or listing fails.
