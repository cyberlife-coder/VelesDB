...
test('generated index.d.ts declares the full 20-method surface (guards against a stale, hand-edited .d.ts)', () => {
  ...
  // Same 20 names as the "surface allowlist" test above, in camelCase.
