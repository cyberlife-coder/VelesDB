...
test('generated index.d.ts declares the full 19-method surface (guards against a stale, hand-edited .d.ts)', () => {
  ...
  // Same 19 names as the "surface allowlist" test above, in camelCase.
