...
test('generated index.d.ts declares the full 14-method surface (guards against a stale, hand-edited .d.ts)', () => {
  ...
  // Same 14 names as the "surface allowlist" test above, in camelCase.
