...
test('generated index.d.ts declares the full 21-method surface (guards against a stale, hand-edited .d.ts)', () => {
  ...
  // Same 21 names as the "surface allowlist" test above, in camelCase.
