...
test('generated index.d.ts declares the full 18-method surface (guards against a stale, hand-edited .d.ts)', () => {
  ...
  // Same 18 names as the "surface allowlist" test above, in camelCase.
