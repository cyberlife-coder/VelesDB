...
| Codex CLI | Supported | `codex mcp add`, or a `[mcp_servers.*]` table. Codex has lifecycle hooks, but none is implemented here yet — an `AGENTS.md` convention is documented instead. |
...
`velesdb-memory v0.11.1` · Last updated: 2026-07-25 · [Report a docs error](https://github.com/cyberlife-coder/VelesDB/issues)
